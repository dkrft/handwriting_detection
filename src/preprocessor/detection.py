...
class Handwriting_Preprocessor():
    ...
    def detect_handwriting(self, img, verbose=False, repititions=1):
        ...
        labels = rdbscan(bottom_points, 150, 10, min_samples=15)
        # labels = rdbscan(bottom_points, epsilon_v_1, epsilon_h_1, min_samples=min_samples_1)
        ...
        labels = rdbscan(points, epsilon_v_2, epsilon_h_2, min_samples=min_samples_2)
